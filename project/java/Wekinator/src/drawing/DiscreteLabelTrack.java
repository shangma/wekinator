 ...
 * @author rebecca
 */
public class DiscreteLabelTrack implements LabelTrack {
    ...
    public DiscreteLabelTrack(float w, float h, int mini, int maxi, float[] hues, SimpleDataset d, int myId, PApplet app) {
        //   this.x = x;
        //   this.y = y;
        p = app;
        this.d = d;
