...
public class BeatboxWekinatorWrapperNew {
    ...
    public void addTrainingExampleListener(TrainingExampleListenerNew l) {
        trainingListenerList.add(TrainingExampleListenerNew.class, l);
    }

    public void removeTrainingExampleListener(TrainingExampleListenerNew l) {
        trainingListenerList.remove(TrainingExampleListenerNew.class, l);
    }
    ...
    public BeatboxWekinatorWrapperNew(int numFeatures, int maxClasses) throws Exception {
    ...
    public void deleteTrainingExampleIds(int[] ids) {
    ...
    public static BeatboxWekinatorWrapperNew loadFromFile(File f) throws Exception {
        BeatboxWekinatorWrapperNew w = (BeatboxWekinatorWrapperNew)SerializedFileUtil.readFromFile(f);
        return w;
    }
    ...
    protected void newClassificationResult(int id, int classValue) {
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == ClassificationListenerNew.class) {
                ((ClassificationListenerNew) listeners[i + 1]).fireClassificationResult(id, classValue);
            }
        }
    }
    ...
    protected void newTrainingExampleRecorded(int id) {
        ...
        // those that are interested in this event
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == TrainingExampleListenerNew.class) {
                ((TrainingExampleListenerNew) listeners[i + 1]).fireTrainingExampleRecorded(id);
            }
        }
    }
