 ...
 * @author fiebrink
 */
public class BeatboxWekinatorWrapper_tmp {
    ...
    public BeatboxWekinatorWrapper_tmp(int numFeatures, int numClasses, String[] featureNames) {
    ...
    public static BeatboxWekinatorWrapper_tmp loadFromFile(File f) {
