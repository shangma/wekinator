...
public class icmc_visual_synth extends PApplet {
...
boolean isSendingParams = false;
String sendHostname = "127.0.0.1"; //127.0.0.1
int sendPort = 6453;
...
public void startSendingParams(String s, int i, float f) {
  if (! s.equals(sendHostname) || i != sendPort) {
      dest = new NetAddress(s,i);
...
public void setParams(float f1, float f2, float f3) {
  c.x = f1;
  c.y = f2;
  c.r = f3;
...
public class Circle {
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#c0c0c0", "icmc_visual_synth" });
  }
}
