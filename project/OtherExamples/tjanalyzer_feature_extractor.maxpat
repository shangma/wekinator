{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 123.0, 44.0, 1089.0, 792.0 ],
		"bglocked" : 0,
		"defrect" : [ 123.0, 44.0, 1089.0, 792.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 42.0, 674.0, 447.0, 20.0 ],
					"id" : "obj-149",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 1,
					"patching_rect" : [ 440.0, 859.0, 278.0, 34.0 ],
					"id" : "obj-146",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 439.0, 838.0, 271.0, 20.0 ],
					"id" : "obj-147",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"numinlets" : 1,
					"patching_rect" : [ 459.0, 781.0, 447.0, 34.0 ],
					"id" : "obj-142",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "Use pak to send on every feature update, pack to send on 1st feature update. Use metro to send at constant 100ms, at minimum.",
					"linecount" : 3,
					"numinlets" : 1,
					"patching_rect" : [ 461.0, 738.0, 285.0, 43.0 ],
					"id" : "obj-135",
					"fontname" : "Geneva",
					"numoutlets" : 0,
					"fontsize" : 9.0
...
, 			{
				"box" : 				{
					"maxclass" : "toggle",
					"numinlets" : 1,
					"patching_rect" : [ 121.0, 692.0, 20.0, 20.0 ],
					"id" : "obj-154",
					"numoutlets" : 1,
					"outlettype" : [ "int" ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "metro 100",
					"numinlets" : 2,
					"patching_rect" : [ 127.0, 718.0, 65.0, 20.0 ],
					"id" : "obj-153",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
...
, 			{
				"box" : 				{
					...
					"text" : "print",
					"numinlets" : 1,
					"patching_rect" : [ 215.0, 799.0, 34.0, 20.0 ],
					"id" : "obj-141",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "t b s",
					"numinlets" : 1,
					"patching_rect" : [ 288.0, 789.0, 33.0, 20.0 ],
					"id" : "obj-136",
					"fontname" : "Arial",
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 292.0, 814.0, 143.0, 20.0 ],
					"id" : "obj-137",
					"fontname" : "Arial",
					"numoutlets" : 3,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 290.0, 763.0, 169.0, 20.0 ],
					"id" : "obj-138",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 9,
					"patching_rect" : [ 290.0, 736.0, 156.0, 20.0 ],
					"id" : "obj-139",
					"fontname" : "Arial",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 292.0, 845.0, 137.0, 20.0 ],
					"id" : "obj-140",
					"fontname" : "Arial",
					"numoutlets" : 0,
					"fontsize" : 12.0
...
, 			{
				"box" : 				{
					...
					"text" : "0. 0.",
					"numinlets" : 2,
					"patching_rect" : [ 419.0, 600.0, 62.0, 17.0 ],
					"id" : "obj-92",
					"fontname" : "Geneva",
					"numoutlets" : 1,
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"patching_rect" : [ 106.0, 643.0, 139.0, 19.0 ],
					"id" : "obj-121",
					"fontname" : "Geneva",
					"numoutlets" : 0,
					"fontsize" : 9.0
